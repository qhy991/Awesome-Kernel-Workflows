...
| Method | Type | Workflow | Core loop | Paper / project |
|--------|------|----------|-----------|-----------------|
| [AccelOpt](AccelOpt/) | Academic | [`accelopt-kernel-optimization`](AccelOpt/accelopt-kernel-optimization.js) | Setup → Plan → Execute → Evaluate → Learn → Iterate (**NCU-guided**) | [arXiv:2511.15915](https://arxiv.org/abs/2511.15915) (MLSys 2026) |
