...
const WORKFLOW_SUITABILITY = {
  ...
  problem_types: ['strategy-level CUDA evolution', 'roofline/profiler-guided CUDA optimization'],
  reason: 'cuPilot is CUDA-specific and depends on NVCC/function checks, NCU, and roofline-style evidence.',
}
